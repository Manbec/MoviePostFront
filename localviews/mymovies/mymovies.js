'use strict';
var moviepost = angular.module('moviepost.mymovies', []);

moviepost.config(['$routeProvider', 'EnvironmentConfig', function ($routeProvider, EnvironmentConfig) {

  $routeProvider.when("/mymovies", {
    templateUrl: EnvironmentConfig.views + 'views/mymovies/mymovies.html',
    controller: 'MyMoviesCtrl'
  });

}]);

moviepost.controller('MyMoviesCtrl', ['$scope', '$http', 'EnvironmentConfig', function ($scope, $http, EnvironmentConfig) {
  ...
  $scope.myMoviesUrl = EnvironmentConfig.api + '/user/movies';
