'use strict';
var moviepost = angular.module('moviepost.search', []);

moviepost.config(['$routeProvider', 'EnvironmentConfig', function ($routeProvider, EnvironmentConfig) {

  $routeProvider.when("/search/:query", {
    templateUrl: EnvironmentConfig.views + 'views/search/search.html',
    controller: 'SearchCtrl'
  });

}]);

moviepost.controller('SearchCtrl', ['$scope', '$http', '$routeParams', 'EnvironmentConfig', function ($scope, $http, $routeParams, EnvironmentConfig) {
  ...
  $scope.popularMoviesUrl = "https://api.themoviedb.org/3/search/movie";
